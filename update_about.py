...
content = re.sub(re.escape(story_old), story_new, content)
...
content = re.sub(re.escape(values_header_old), values_header_new, content)

with open('about.html', 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated about.html successfuly.")
